import { WeightedValue } from "./WeightedValue.js";
import { uniqueEquipment } from "./uniqueEpuipment.js";
import { clamp, isBetween } from "./helper.js";
...
const weightedChallengeTypes = challengeTypes.map(ct => new WeightedValue(ct, ct.weight));

export { ChallengeType, challengeTypes, challTypeWeightReduce, weightedChallengeTypes };